...
"""
from __  -i, --ignore-interrupts   ignore interrupt signals
...
The default MODE for the -p option is 'exit-nopipe'.
The default operation when --output-error is not specified is to exit immediately on error writing to a pipe and diagnose errors writing to non-pipe outputs. annotations
