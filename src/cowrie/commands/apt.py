# Copyright (c) 2009 Upi Taimport random
import re
...
class Command_aptget(HoneyPotCommand):
    """
    apt-get fake
    supports only the 'install PACKAGE' command & 'moo'.
...
pages for more information and options.
    ...
    async def do_install(self, *args) -> None:
        if len(self.args) <= 1:
        ...
        for p in self.packages:
            ...
            await self.sleep(2)
        self.exit() collections.abc import Callable
