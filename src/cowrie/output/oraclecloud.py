...
class Output(cowrie.core.output.Output):
    ...
    def generate_random_log_id(self):
        charset = string.ascii_letters + string.digits  # Double quotes would conflict with docstring
    ...
    def sendLogs(self, logentry):
        ...
        try:
            ...
            self.log.err(f"Oracle Cloud plugin Error: {ex}")
            raise
    ...
    def start(self):
        ...
        authtype: str = CowrieConfig.get("output_oraclecloud", "authtype")
